...
| 变更类型 | 触发条件 | 递增级别 | 示例 |
|---------|---------|---------|------|
| 🔴 重大重构 | 核心架构变更、BREAKING CHANGE | major | 3.3.0-alpha → 3.3.0-alpha |
| 🟢 新功能 | 新增模块、新功能实现 | minor | 3.3.0-alpha → 3.3.0-alpha |
| 🔵 Bug 修复 | 错误修复、性能优化 | patch | 3.3.0-alpha → 3.3.0-alpha |
| 📝 文档更新 | 仅修改文档 | patch | 3.3.0-alpha → 3.3.0-alpha |
| ⚙️ 配置调整 | 配置文件变更 | patch | 3.3.0-alpha → 3.3.0-alpha |
