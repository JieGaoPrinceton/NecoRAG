...
- [parser.py](file://src/whiskers/parser.py)
- [chunker.py](file://src/whiskers/chunker.py)
- [encoder.py](file://src/whiskers/encoder.py)
- [tagger.py](file://src/whiskers/tagger.py)
- [models.py](file://src/whiskers/models.py)
- [__init__.py](file://src/whiskers/__init__.py)
- [README.md](file://src/whiskers/README.md)
...
Whiskers Engine（胡须感知引擎）是 NecoRAG 的感知层核心组件，负责多模态数据的高精度编码与情境标记。就像猫的胡须能敏锐感知环境微变化一样，本引擎负责"感知"和"理解"输入的各种数据。

该引擎实现了文档解析、多模态编码和情境标签生成三大核心功能，为整个 NecoRAG 系统提供高质量的数据预处理能力。

## 项目结构

Whiskers Engine 位于 `src/whiskers/` 目录下，包含以下核心文件：

```mermaid
graph TB
subgraph "Whiskers Engine 核心模块"
A[engine.py<br/>主引擎类]
...
**图表来源**
- [engine.py:1-130](file://src/whiskers/engine.py#L1-L130)
- [parser.py:1-112](file://src/whiskers/parser.py#L1-L112)
- [encoder.py:1-98](file://src/whiskers/encoder.py#L1-L98)

**章节来源**
- [engine.py:1-130](file://src/whiskers/engine.py#L1-L130)
- [__init__.py:1-23](file://src/whiskers/__init__.py#L1-L23)

## 核心组件

Whiskers Engine 由五个核心组件构成，每个组件都有明确的职责分工：

### 1. WhiskersEngine 主引擎
...
- [parser.py:11-112](file://src/whiskers/parser.py#L11-L112)
- [chunker.py:10-98](file://src/whiskers/chunker.py#L10-L98)
- [encoder.py:11-98](file://src/whiskers/encoder.py#L11-L98)
- [tagger.py:10-144](file://src/whiskers/tagger.py#L10-L144)
...
**图表来源**
- [engine.py:54-106](file://src/whiskers/engine.py#L54-L106)
- [parser.py:27-59](file://src/whiskers/parser.py#L27-L59)
- [chunker.py:58-82](file://src/whiskers/chunker.py#L58-L82)
- [encoder.py:28-42](file://src/whiskers/encoder.py#L28-L42)
- [tagger.py:32-47](file://src/whiskers/tagger.py#L32-L47)

## 详细组件分析

### WhiskersEngine 主引擎

WhiskersEngine 是感知层的核心协调者，负责组织整个数据处理流程。
...
**图表来源**
- [engine.py:92-129](file://src/whiskers/engine.py#L92-L129)
...
**图表来源**
- [tagger.py:32-143](file://src/whiskers/tagger.py#L32-L143)
...
Whiskers Engine 使用一组精心设计的数据模型来表示处理过程中的各种数据结构。
...
**图表来源**
- [models.py:11-69](file://src/whiskers/models.py#L11-L69)
...
```mermaid
graph TB
subgraph "Whiskers Engine 内部依赖"
A[WhiskersEngine] --> B[DocumentParser]
A --> C[ChunkStrategy]
A --> D[VectorEncoder]
...
**图表来源**
- [engine.py:6-10](file://src/whiskers/engine.py#L6-L10)
- [README.md:137-143](file://src/whiskers/README.md#L137-L143)

### 组件耦合度分析

Whiskers Engine 在设计上采用了良好的模块化原则：
...
**章节来源**
- [README.md:137-158](file://src/whiskers/README.md#L137-L158)
...
**章节来源**
- [parser.py:41-42](file://src/whiskers/parser.py#L41-L42)
- [engine.py:21-27](file://src/whiskers/engine.py#L21-L27)

## 结论

Whiskers Engine 作为 NecoRAG 框架的感知层，展现了优秀的模块化设计和清晰的职责分离。虽然当前实现主要基于占位符和最小可用版本，但其架构设计为未来的功能扩展奠定了坚实的基础。
