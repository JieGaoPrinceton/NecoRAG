...
python: ">=3.9"
numpy: "^3.3.0-alpha"
python-dateutil: "^3.3.0-alpha"

# Web 框架
fastapi: "^3.3.0-alpha"
uvicorn: "^3.3.0-alpha"
pydantic: "^3.3.0-alpha"

# AI/ML 模型
transformers: "^3.3.0-alpha"
torch: "^3.3.0-alpha"
sentence-transformers: "^3.3.0-alpha"

# 数据库客户端
redis: "^3.3.0-alpha"
qdrant-client: "^3.3.0-alpha"
neo4j: "^3.3.0-alpha"
...
# 文档处理
ragflow-sdk: "^3.3.0-alpha"  # 假设
pytesseract: "^3.3.0-alpha"

# 任务调度
apscheduler: "^3.3.0-alpha"
celery: "^3.3.0-alpha"

# 监控
prometheus-client: "^3.3.0-alpha"

# 工具库
python-dotenv: "^3.3.0-alpha"
pyyaml: "^3.3.0-alpha"
```
