...
## 项目结构
NecoRAG 的部署与运维主要集中在 devops 目录下的容器化配置与脚本，以及 Dashboard 的运行入口与配置管理模块。整体结构如下：
...
- [Dockerfile:30-38](file://devops/Dockerfile#L30-L38)
...
章节来源
- [docker-compose.yml:16-94](file://devops/docker-compose.yml#L16-L94)
- [status.sh:1-48](file://devops/scripts/status.sh#L1-L48)
- [stop.sh:21-35](file://devops/scripts/stop.sh#L21-L35)
- [pull-model.sh:15-23](file://devops/scripts/pull-model.sh#L15-L23)
