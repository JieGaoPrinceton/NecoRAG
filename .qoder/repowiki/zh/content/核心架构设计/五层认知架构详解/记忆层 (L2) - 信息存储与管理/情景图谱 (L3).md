...
- 关系强度：Relation.strength 默认为 1.0，建议结合置信度、共现频次、时间衰减、领域权重等进行动态计算，作为多跳传播的权重或排序依据。
...
### Neo4j 集成与部署参考
- Docker 部署与 APOC 插件安装
- Docker Compose 模板与服务编排
- 图数据库性能参数调优

**章节来源**
- [deployment_quickref.md:299-760](file://3rd/legacy/deployment_quickref.md#L299-L760)