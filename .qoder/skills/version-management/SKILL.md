...
**示例**: `3.3.0-alpha`, `3.3.0-alpha`, `3.3.0-alpha`
...
```bash
# 递增补丁版本 (3.3.0-alpha -> 3.3.0-alpha)
python tools/version_manager.py bump patch

# 递增次要版本 (3.3.0-alpha -> 3.3.0-alpha)
python tools/version_manager.py bump minor

# 递增主版本 (3.3.0-alpha -> 3.3.0-alpha)
...
| 问题 | 解决方案 |
|------|---------|
| VERSION 文件不存在 | 创建文件并写入初始版本，如 `3.3.0-alpha` |
