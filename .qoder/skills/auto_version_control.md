...
| 变更类型 | 检测条件 | 递增级别 | 示例 |
|---------|---------|---------|------|
| **重大重构** | 修改核心架构文件 | major | 2.0.1-alpha → 2.0.1-alpha |
| **新功能** | 新增模块/功能文件 | minor | 2.0.1-alpha → 2.0.1-alpha |
| **Bug 修复** | 修复错误、优化性能 | patch | 2.0.1-alpha → 2.0.1-alpha |
| **文档更新** | 仅修改 .md 文件 | patch | 2.0.1-alpha → 2.0.1-alpha |
| **配置调整** | 修改配置文件 | patch | 2.0.1-alpha → 2.0.1-alpha |
...
变更类型：文档更新 + 配置调整
建议版本递增：patch (2.0.1-alpha -> 2.0.1-alpha)
...
检测到变更，请确认版本递增级别:
  1) patch (2.0.1-alpha -> 2.0.1-alpha) - 推荐
  2) minor (2.0.1-alpha -> 2.0.1-alpha)
  3) major (2.0.1-alpha -> 2.0.1-alpha)
  4) skip (跳过本次更新)
