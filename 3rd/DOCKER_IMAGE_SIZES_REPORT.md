...
#### 1. milvusdb/milvus:v3.0.1-alpha
...
**详细信息**:
```
Image: milvusdb/milvus:v3.0.1-alpha
...
└─ milvusdb/milvus:v3.0.1-alpha  ████████████████████████████████████████████████████████████████████████████████████████████████████████████████████ 707MB   (41.7%)
```
...
```bash
# 根据需求选择特定镜像
docker pull milvusdb/milvus:v3.0.1-alpha      # 需要 Milvus 时
...
| # | 镜像名称 | 大小 | 用途 | 说明 |
|---|---------|------|------|------|
| 1 | milvusdb/milvus:v3.0.1-alpha | ~707MB | Milvus 向量数据库 | Qdrant 的替代方案 |
