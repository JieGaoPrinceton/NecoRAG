...
| 变更类型 | 检测条件 | 递增级别 | 示例 |
|---------|---------|---------|------|
| **重大重构** | 修改核心架构文件 | major | 3.3.0-alpha → 3.3.0-alpha |
| **新功能** | 新增模块/功能文件 | minor | 3.3.0-alpha → 3.3.0-alpha |
| **Bug 修复** | 修复错误、优化性能 | patch | 3.3.0-alpha → 3.3.0-alpha |
| **文档更新** | 仅修改 .md 文件 | patch | 3.3.0-alpha → 3.3.0-alpha |
| **配置调整** | 修改配置文件 | patch | 3.3.0-alpha → 3.3.0-alpha |
...
变更类型：文档更新 + 配置调整
建议版本递增：patch (3.3.0-alpha -> 3.3.0-alpha)

✓ 已更新 VERSION 文件：3.3.0-alpha
✓ 已更新 pyproject.toml: 3.3.0-alpha
...
检测到变更，请确认版本递增级别:
  1) patch (3.3.0-alpha -> 3.3.0-alpha) - 推荐
  2) minor (3.3.0-alpha -> 3.3.0-alpha)
  3) major (3.3.0-alpha -> 3.3.0-alpha)
  4) skip (跳过本次更新)
