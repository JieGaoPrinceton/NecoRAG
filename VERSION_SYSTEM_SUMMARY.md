...
已成功创建完整的版本号管理系统，从 **v2.0.1-alpha** 开始，支持自动递增和批量同步。
...
# 递增补丁号（2.0.1-alpha -> 2.0.1-alpha）
python tools/version_manager.py bump patch

# 递增次版本号（2.0.1-alpha -> 2.0.1-alpha）
python tools/version_manager.py bump minor

# 递增主版本号（2.0.1-alpha -> 2.0.1-alpha）
...
- ✅ 完整版本号：`v2.0.1-alpha`, `V2.0.1-alpha-alpha`
- ✅ 短版本号：`v2.0`
- ✅ 纯文本版本号：`2.0.1-alpha`
