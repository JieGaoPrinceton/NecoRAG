...
#### 7. 自适应学习引擎 (Adaptive Learning Engine)
...
| 画像维度 | 数据项 | 更新频率 | 说明 |
|---------|--------|---------|------|
| 知识水平 | expertise_level (0-1) | 每次查询 | 用户在各领域的专业度评估 |
| 偏好风格 | preferred_tone, detail_level | 每次反馈 | 回答风格偏好 |
| 查询习惯 | query_patterns, active_hours | 每日聚合 | 用户查询行为模式 |
| 满意度 | satisfaction_score (0-1) | 每次反馈 | 用户对回答的满意趋势 |
