...
智能路由与策略融合引擎是NecoRAG v2.0版本新增的核心模块，基于认知科学理论构建的下一代智能RAG（Retrieval-Augmented Generation）框架。该引擎通过三层决策架构，实现了从语义意图识别到个性化策略选择的完整智能路由系统。
...
Level4[LEVEL_4<br/>较大降级<br/>返回缓存]
end
subgraph "降级触发条件"
Latency[延迟超限]
Resource[资源不足]
...
- [config.py:390-420](file://src/core/config.py#L390-L420)
...
智能路由与策略融合引擎作为NecoRAG v2.0版本的核心创新模块，实现了以下重要突破：
