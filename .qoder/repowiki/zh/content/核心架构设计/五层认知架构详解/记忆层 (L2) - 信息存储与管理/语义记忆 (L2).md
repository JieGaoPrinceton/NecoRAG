...
- [third_party_integration.md](file://wiki/wiki/核心架构设计/第三方系统集成文档体系.md)
</cite>
...
### 向量数据库集成指南
- Qdrant 部署与配置
  - 单机部署：容器化部署，支持持久化存储与日志配置
  - 集群部署：3 节点集群，支持 Raft 协议与节点发现
  - 性能调优：HNSW 索引参数（M、ef_construct）、线程池配置
- Milvus 选型对比
  - 功能完整性：支持多种索引类型与分布式架构
  - 社区生态：活跃的社区与完善的文档体系
  - 成本考虑：企业版收费模式，需评估部署与维护成本

章节来源
- [deployment_quickref.md:221-298](file://3rd/legacy/deployment_quickref.md#L221-L298)
- [third_party_integration.md:470-480](file://wiki/wiki/核心架构设计/第三方系统集成文档体系.md#L470-L480)