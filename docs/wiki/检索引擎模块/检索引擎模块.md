...
- RRF：对同一文档在不同来源中的排名取倒数并求和，再按分数排序。
...
## 结论
本模块以“自适应检索”为核心，融合 HyDE 增强、扩散激活理论、领域权重与早停机制，形成高效、可解释、可扩展的检索体系。通过结果融合与重排序提升质量，借助可视化与追踪帮助用户理解检索过程。与记忆层与感知编码的集成，使系统具备从感知到检索的全链路能力。
