...
## 更新摘要
**变更内容**
- 完全重构为三层决策架构：意图识别层、用户画像层、策略融合层
- 新增CoT思维链控制、早停与降级机制、反馈闭环学习等高级功能
- 更新了所有核心组件的实现和交互方式
- 增强了性能监控和统计功能
...
智能路由与策略融合引擎是NecoRAG v1.9版本新增的核心模块，基于认知科学理论构建的下一代智能RAG（Retrieval-Augmented Generation）框架。该引擎通过三层决策架构，实现了从语义意图识别到个性化策略选择的完整智能路由系统。

### 核心创新特性

- **三层决策架构**：意图识别层、用户画像层、策略融合层的协同决策
...
智能路由与策略融合引擎作为NecoRAG v1.9版本的核心创新模块，实现了以下重要突破：
