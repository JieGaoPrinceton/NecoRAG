...
```
主版本号。次版本号.补丁号 - 预发布标识
例如：3.2.0-alpha, 3.2.0-alpha, 3.2.0-alpha
```
...
| 模式 | 示例 | 替换为 |
|------|------|--------|
| `v3.2.0-alpha` | README 徽章 | `v3.2.0-alpha` |
| `V3.2.0-alpha-alpha-alpha-alpha-alpha-alpha-alpha-alpha` | 标题中的大写版本 | `V3.2.0-alpha-alpha-alpha-alpha-alpha-alpha-alpha-alpha` |
| `3.2.0-alpha` | 纯文本版本号 | `3.2.0-alpha` |
| `v3.2` | 短版本号 | `v3.2` |
...
# 3. 提交并推送
git add .
git commit -m "fix: release 3.2.0-alpha with critical bug fixes"
git push
```
...
| 版本 | 日期 | 说明 |
|------|------|------|
| 3.2.0-alpha | 2026-03-19 | 智能路由与策略融合引擎 ⭐ |
| 3.2.0-alpha | 2026-03-19 | Interface 模块增强 |
| 3.2.0-alpha | 2026-03-19 | 可视化调试面板 ⭐ |
| 3.2.0-alpha | 2026-03-17 | MVP 版本发布 |
...
- [语义化版本规范 3.2.0-alpha](https://semver.org/lang/zh-CN/)
- [Keep a Changelog](https://keepachangelog.com/zh-CN/3.2.0-alpha/)
