...
[![Version](https://img.shields.io/badge/version-2.0.1-alpha-blue.svg)](CHANGELOG.md)
...
### 🆕 新增核心模块（v2.0.1-alphaa1.9.0-alpha）

```
┌─────────────────────────────────────────────────────────┐
│         NecoRAG v2.0.1-alpha 新增：智能路由与策略融合引擎       │
├─────────────────────────────────────────────────────────┤
│                                                          │
...
### 使用 Interface 模块（v2.0.1-alpha 新增）
...
| domain_weight_enabled | bool | True | 启用领域权重（v2.0.1-alpha） |
...
| evolution_enabled | bool | True | 启用知识演化（v2.0.1-alpha） |
...
| **调试面板覆盖率** | 100% | ✅ 完成 | v2.0.1-alpha 新增 |
| **智能路由引擎** | 完整 | ✅ 完成 | v2.0.1-alpha 新增 ⭐ |
| **代码质量** | 良好 | ✅ 80.2% | 代码密度 |
...
- 🔄 动态重排序与 Novelty 检测
- 🔄 意图分析系统（v2.0.1-alpha 已完成）⭐
- 🔄 领域权重系统（v2.0.1-alpha 已完成）⭐
- 🔄 知识演化系统（v2.0.1-alpha 已完成）⭐
- 🔄 监控告警系统（v2.0.1-alpha 已完成）⭐
- 🔄 安全模块（v2.0.1-alpha 已完成）⭐
- 🔄 自适应优化（v2.0.1-alpha 已完成）⭐
- 🔄 插件扩展系统（v2.0.1-alpha 已完成）⭐
- 🔄 Interface 模块（v2.0.1-alpha 已完成）⭐
- ✅ **智能路由与策略融合引擎**（v2.0.1-alpha 已完成）⭐⭐⭐
...
- 🚀 异步知识固化与自动遗忘
- 📊 **可视化调试面板** (NecoRAG Dashboard) - ✅ v2.0.1-alpha 已完成 ⭐
- 🔌 插件市场和扩展系统 - ✅ 框架已完成 ⭐
- 🌍 社区运营和开源生态建设
- 🏢 企业级功能增强（多租户、审计、报表）
- 📱 移动端应用开发
...
### 🆕 新增模块文档（v2.0.1-alphaa1.9.0-alpha）
