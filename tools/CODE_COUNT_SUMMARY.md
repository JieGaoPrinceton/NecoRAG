...
| [`tools/code_count_v3.0.1-alpha_*.md`](/Users/ll/NecoRAG/tools/) | 实际运行生成的报告 |
...
# 生成文件名示例：
# code_count_v3.0.1-alpha_20260319_122145.md
```
...
# 将报告添加到发布说明
cat release_v3.0.1-alphaa.md >> RELEASE_NOTES.md
```
...
|------|------|--------|----------|--------|--------|
| v3.0.1-alpha | 2025-01-15 | 50,000 | 40,000 | 150 | 8.0% |
| v3.0.1-alpha | 2025-06-20 | 120,000 | 95,000 | 320 | 7.5% |
| v3.0.1-alpha | 2026-03-19 | 206,302 | 163,586 | 540 | 4.1% |
