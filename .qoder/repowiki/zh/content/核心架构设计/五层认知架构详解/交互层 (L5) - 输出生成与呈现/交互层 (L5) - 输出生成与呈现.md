...
交互层（L5）是 NecoRAG 系统的核心组件，负责情境自适应生成与可解释性输出。该模块借鉴了猫通过呼噜声与人类交流的特性，专注于"表达"和"沟通"，提供人性化、可解释的交互体验。
...
- [src/dashboard/components/ReasoningChainChart.html:1-800](file://src/dashboard/components/ReasoningChainChart.html#L1-L800)
...
**章节来源**
- [src/refinement/models.py:10-46](file://src/refinement/models.py#L10-L46)
- [src/core/protocols.py:254-277](file://src/core/protocols.py#L254-L277)