...
#### 1. milvusdb/milvus:v3.0.0-alpha
...
**详细信息**:
```
Image: milvusdb/milvus:v3.0.0-alpha
...
└─ milvusdb/milvus:v3.0.0-alpha  ████████████████████████████████████████████████████████████████████████████████████████████████████████████████████ 707MB   (41.7%)
```
...
```bash
# 根据需求选择特定镜像
docker pull milvusdb/milvus:v3.0.0-alpha      # 需要 Milvus 时
